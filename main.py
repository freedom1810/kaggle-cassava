...
from nets_test import EfficientNetB3DSPlus, ModelEMA, VitB3DSPlus
...
path_params = {
    ...
    'save_path': "checkpoints/54/{}_fold-{}"
...
for fold in range(1):
    ...
    if optimizer_params['weighted_loss']:
        criterion = LabelSmoothingLoss(weight = optimizer_params['weight_loss'])
